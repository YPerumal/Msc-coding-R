...
```{r}
# copy train data 
imput_train_df <- x_train
#create column for predictions i.e. missing values
imput_train_df['ImputedGammaGT'] <- NA

# copy test data 
imput_test_df <- x_test
#create column for predictions i.e. missing values
imput_test_df['ImputedGammaGT'] <- NA
```

## MICE
```{r}
init = mice(imput_train_df, maxit=0) 
meth = init$method
